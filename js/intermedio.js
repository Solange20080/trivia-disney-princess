 ...
 const preguntas = [
    ...
    {
        pregunta: "¿Qué objeto mágico utiliza la madrastra de Blancanieves?",
        respuestas: ["Un espejo", "Una bola de cristal", "Una lámpara", "Un collar"],
        correcta: 0
    },

    {
        pregunta: "¿Como se llama el  amigo tigre de jasmine?",
        respuestas: ["Rajah", "Erick", "Damian", "Diego"],
        correcta: 0
    },

    {
        pregunta: "¿Como se llamn las 3 hadas que cuidaron a Aurora?",
        respuestas: ["Melodi,Ariel,Bella", "Anastasia,Crisella,Cenicienta", "Flora,Fauna,Primavera", "Rapunzel,Sofia,Moana"],
        correcta: 2
    }
